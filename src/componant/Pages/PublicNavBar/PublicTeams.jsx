    ...
    <div className="public-teams-page" dir="rtl">
      ...
      <div className="page-header">
        <div className="header-content">
          <div className="header-text">
            ...
            <p className="page-subtitle">ترتيب الأكاديميات حسب النقاط والأداء</p>
          </div>
      ...
      {teamsData.length >= 3 && (
        <div className="top-teams-showcase">
          <h2 className="showcase-title">🥇 أفضل 3 أكاديميات</h2>
          <div className="top-teams-podium">
            {teamsData.slice(0, 3).map((team, index) => (
              <div key={team.academyName} className={`podium-card ${getRankBadgeStyle(index)}`}>
      ...
      <div className="teams-table-section">
        <div className="table-header">
          <h2 className="table-title">📊 الجدول الكامل</h2>
          <div className="table-stats">
            <span className="total-teams">إجمالي الفرق: {teamsData.length}</span>
          </div>
        </div>
            ...
            <table className="teams-table">
              ...
              <tbody>
                {teamsData.map((team, index) => (
                  <tr key={team.academyName} className={`table-row ${getRankBadgeStyle(index)}`}>
                    ...
                    <td className="stat-cell goals-against">{team.goalsAgainst}</td>
                    <td className={`stat-cell goal-diff ${team.goalDifference >= 0 ? 'positive' : 'negative'}`}>
        ...
        <div className="summary-cards">
          <div className="summary-card">
            ...
            <div className="summary-content">
              <span className="summary-value">{teamsData.reduce((sum, team) => sum + team.goalsFor, 0)}</span>
          ...
          <div className="summary-card">
            ...
            <div className="summary-content">
              <span className="summary-value">{teamsData.reduce((sum, team) => sum + team.matchesPlayed, 0)}</span>
          ...
          <div className="summary-card">
            <div className="summary-icon">🏆</div>
            <div className="summary-content">
              <span className="summary-value">{teamsData.reduce((sum, team) => sum + team.wins, 0)}</span>
          ...
          <div className="summary-card">
            <div className="summary-icon">🤝</div>
            <div className="summary-content">
              <span className="summary-value">{teamsData.reduce((sum, team) => sum + team.draws, 0)}</span>
