    ...
    <div className="bg-gray-100 min-h-screen p-4" dir="rtl">
      ...
      <div className="bg-white rounded shadow p-4 max-w-4xl mx-auto">
        <div className="flex items-center justify-center mb-4">
          <button className="bg-[#2563eb] text-white px-4 py-2 rounded font-medium">{new Date(match.date).toLocaleDateString('ar-EG')}</button>
        </div>
        <div className="text-center text-xl font-bold mb-6 text-[#2563eb]">{new Date(match.date).toLocaleDateString('ar-EG')}</div>
        ...
        <div className="bg-gray-50 rounded-lg shadow p-6 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between border-t pt-4">
            ...
            <div className="text-2xl font-extrabold text-[#2563eb]">{match.homeTeamScore} - {match.awayTeamScore}</div>
